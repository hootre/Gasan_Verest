		...
		<div class="mid">
			...
			<sec:authorize access="hasRole('ADMIN') or hasRole('USER') ">
				<div class="review_write">
					...
					<form action="<c:url value='/back/new'/>" method="post"
						id="fmField" name="fmField" onsubmit="return checkForm();">
						<table>
							<tr>
								<th>작성자</th>
							...
							<tr>
								<th>제목</th>
								<td><input type="text" id="title" placeholder="제목"
									maxlength="15" name="title" required /></td>
							</tr>
							<tr>
								<th>내용</th>
								<td><textarea id="txt" placeholder="내용"
										style="resize: none;" name="content" cols="30" rows="5"
										maxlength="50" required></textarea></td>
							</tr>
							<tr>
								<th>별점</th>
								...
								</select><input type="submit" class="submit" value="작성하기"></td>
							</tr>
						</table>
			...
			<sec:authorize access="!hasRole('ADMIN') and !hasRole('USER')">
				<div class="review_login">
					<h3>
						후기를 남기시려면 <a href="<c:url value='/login'/>">로그인</a>을 하십시오
					</h3>
				</div>
			</sec:authorize>
